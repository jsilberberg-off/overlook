...
export default function StepRenderer({ stepId, data, onChange, onPreview, missingFields = [], showErrors = false }) {
  ...
  const isMissing = (key) => showErrors && missingFields.some(field => field.key === key);
